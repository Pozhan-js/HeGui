<template>
  <div class="app-container">
    ...
    <el-table ref="multipleTable" v-loading="loading" style="margin-top: 20px" :data="jobLogList" :row-key="(row) => row.jobLogId" @selection-change="handleSelectionChange">
...
export default {
  ...
  methods: {
    ...
    handleSelectionChange(selection) {
      ...
      this.checked = this.jobLogList.length === selection.length
    },
    /** 详细按钮操作 */
    handleView(row) {
      this.open = true
